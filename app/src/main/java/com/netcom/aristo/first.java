...
public class  first extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            // Inflate the layout for this fragment
             ...
             model ob1=new model(R.drawable.sky,"kuruvi");
             dataholder.add(ob1);
             model ob2=new model(R.drawable.sky,"kkk");
             dataholder.add(ob2);
             model ob3=new model(R.drawable.sky,"lll");
             dataholder.add(ob3);
             model ob4=new model(R.drawable.sky,"ttttt");
             dataholder.add(ob4);
